...
1. Set up and run the client application
    ...
    1. Have fun playing around with the blank project site!
        - Change some markup in a template file and the site will regenerate automatically
...
1. Use the CLI to deploy your templates! 
    - `npm run start` - Deploy your site to TS!
